...
const login = require('./mock/login.js');
const newOpro = require('./mock/newOpro.js');
const indexList = require('./mock/seriesList.js');
const banners = require('./mock/banner.js');
const menu = require('./mock/menu.js');
const hotSearch = require('./mock/hotSearch.js');
